...
  // 🔑 Importation de 'logout' pour pouvoir déconnecter l'utilisateur
...
      // Assurez-vous que '/me/presences' et les autres routes sont bien implémentées côté backend
...
      
      {/* 🎯 AJOUT du bouton de déconnexion en haut */}
