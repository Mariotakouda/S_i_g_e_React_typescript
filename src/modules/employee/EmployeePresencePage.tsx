...
export default function EmployeePresencePage() {
  ...
  const [activePresence, setActivePresence] = useState<EmployeePresence | null>(
    null
  );
  ...
  // 1. On prépare la date (on ajoute 'Z' pour dire au navigateur que c'est de l'UTC)
  const dateStr = dateString.endsWith('Z') ? dateString : dateString.replace(' ', 'T') + 'Z';
  
  // 2. On crée l'objet Date
  const date = new Date(dateStr);

  // 3. On l'utilise pour le retour (C'est ici que l'erreur disparaît)
  ...
  return (
    <div className="bg-light min-vh-100 pb-5">
        ...
        <div className="container py-3">
          <div className="row align-items-center g-2 g-md-3">
            ...
            <div className="col-12 col-md-6 text-center text-md-end">
              <div
                className="h2 fw-bold text-dark mb-0 mobile-time"
      ...
      <div className="container px-2 px-md-3">
        {error && (
          <div className="alert alert-danger border-0 shadow-sm mb-3 d-flex align-items-center gap-2 small py-2">
                ...
                {activePresence ? (
                  <div className="animate-fade-in">
                    <div className="mb-3 mb-md-4">
                      <div
                        className="badge bg-success-subtle text-success px-3 py-2 rounded-pill fw-bold mb-3 border border-success-subtle animate-pulse"
                  ...
                  <div className="py-2 py-md-3 animate-fade-in">
                    <div className="mb-4">
                      ...
                      <h3 className="fw-bold text-dark h5 mb-2">
                        Prêt pour votre service ?
                      </h3>
                      <p
                        className="text-muted mx-auto mb-0 small"
                    ...
                    <button
                      ...
                      className={`btn btn-lg w-100 rounded-4 py-3 shadow-sm fw-bold transition-all d-flex align-items-center justify-content-center gap-2 ${
                        todayPresence
          ...
          <div className="col-12 col-lg-4">
            <div className="row g-2 g-md-3">
              <div className="col-6 col-lg-12">
                <div className="card border-0 shadow-sm rounded-4 p-3 p-md-4 h-100">
                  <div className="d-flex align-items-center gap-2 gap-md-3">
                    <div className="text-primary bg-primary-subtle p-2 p-md-3 rounded-3 shadow-sm d-none d-sm-block">
                      <ClockIcon />
                    </div>
                    <div>
                      <div
                        className="text-muted fw-bold x-small text-uppercase ls-1"
                        style={{ fontSize: "0.65rem" }}
                      >
                        Volume
                      </div>
                      <div className="fw-bold h4 mb-0 text-dark">
                        {stats.totalHours}
                        <small className="h6 text-muted ms-1">h</small>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-6 col-lg-12">
                <div className="card border-0 shadow-sm rounded-4 p-3 p-md-4 h-100">
                  <div className="d-flex align-items-center gap-2 gap-md-3">
                    <div className="text-success bg-success-subtle p-2 p-md-3 rounded-3 shadow-sm d-none d-sm-block">
                      <CalendarIcon />
                    </div>
                    <div>
                      <div
          ...
          <div className="col-12">
            <div className="card border-0 shadow-sm rounded-4 overflow-hidden mt-1 mt-md-2">
              <div className="card-header bg-white border-bottom py-3 px-3 px-md-4 d-flex align-items-center justify-content-between">
                <h6 className="fw-bold mb-0 text-dark small text-uppercase ls-1">
                  Historique récent
                </h6>
                <div
                  className="badge bg-light text-muted fw-normal rounded-pill px-2 px-md-3"
                  style={{ fontSize: "0.65rem" }}
                >
                  5 derniers jours
                </div>
                  ...
                  <tbody>
                    {presences.slice(0, 5).map((p) => (
                      <tr key={p.id} className="transition-all">
                        <td
                          className="ps-3 ps-md-4 py-3 fw-bold text-dark mobile-label"
                          data-label="Date"
                        >
                        ...
                        <td
                          className="text-center fw-medium text-primary mobile-label"
                          data-label="Entrée"
                        >
                          {formatPresenceTime(p.check_in)}
                        </td>
                        <td
                          className="text-center fw-medium text-danger mobile-label"
                          data-label="Sortie"
                        >
                          {p.check_out
                            ? formatPresenceTime(p.check_out)
                            : "--:--"}
                        </td>
                        <td
                          className="pe-3 pe-md-4 text-end mobile-label"
                          data-label="Status"
                        >
                          {p.check_out ? (
                            <span
                              className="badge bg-success-subtle text-success rounded-pill px-2"
                              style={{ fontSize: "0.65rem" }}
                            >
                              Ok
                            </span>
                            ...
                            <span
                              className="badge bg-warning-subtle text-warning rounded-pill px-2"
                              style={{ fontSize: "0.65rem" }}
                            >
                              En cours
                            </span>
