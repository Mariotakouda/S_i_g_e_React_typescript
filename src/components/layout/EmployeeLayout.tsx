...
const Icons = {
  ...
  // L'icône de menu forcée en blanc pour le bouton Indigo
  MenuWhite: () => (
...
export default function EmployeeLayout() {
  ...
  const menuItems = [
    ...
    { label: "Mes Tâches", path: "/employee/tasks", icon: Icons.Tasks }, 
    { label: "Présence", path: "/employee/presences", icon: Icons.Presence },
    { label: "Mes Congés", path: "/employee/leave_requests", icon: Icons.Leave },
    { label: "Annonces", path: "/employee/announcements", icon: Icons.Announcements, badge: managerStatus?.is_manager ? "Manager" : null },
  ];
      ...
      <aside style={{
        ...
        <div style={{ padding: "32px 24px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <span style={{ fontWeight: "700", fontSize: "19px", color: "white" }}>ESPACE HR</span>
          </div>
        ...
        <nav style={{ flex: 1, padding: "0 16px", overflowY: "auto" }}>
          ...
          {managerStatus?.is_manager && (
             <div style={{ marginTop: '20px' }}>
                <p style={menuTitleStyle}>Manager</p>
                <Link to="/employee/announcements/create" style={createBtnStyle}>
        ...
        <div style={sidebarFooterStyle}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "16px" }}>
             <div style={avatarCircleStyle}>{employee?.first_name?.charAt(0) || user?.name?.charAt(0)}</div>
...
const headerAvatarStyle: React.CSSProperties = {
  ...
  display: "flex", alignItems: "center", justifyContent: "center", color: "#4f46e5", fontWeight: "bold"
};

const userNameStyle = { margin: 0, fontSize: "14px", fontWeight: "600" };
